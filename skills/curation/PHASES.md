...
15 pipeline-mode commands drive 13 phases. (The plugin ships 27 commands across five
...
**A phase inserted later takes a letter suffix, never a retired number.** Protocols slot
between Questions and Build as 3b, the same way server-side QC slots after QA as 9b.
Reusing 4 would silently redefine a number that older project notes still use.

The pipeline runs inventory (1) through email (13) — 11 numbers, 13 phases, because 9
splits and 3b was inserted:
